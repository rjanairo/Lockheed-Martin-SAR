...
video_input = jetson.utils.videoSource("0", ["--input-width=1920", "--input-height=1080","--input-rate=21.0"]) # "/dev/video0" "flip-method=2" "--input-flip=rotate-180" 
...
#record to avi
#'''
dir_original ='./Recordings'		# change this to folder where you want to store the video
now = datetime.now()
